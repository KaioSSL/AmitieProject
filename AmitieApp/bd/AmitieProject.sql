DROP DATABASE IF EXISTS AMITIEPROJECT;
CREATE DATABASE AMITIEPROJECT;
...
CREATE TABLE PRODUTO_MATERIA(
	...
	COD_MATERIA_PRIMA INT NOT NULL,
	COD_PRODUTO INT NOT NULL,
	CONSTRAINT COD_MATERIA_PRIMA_FK  KEY(COD_MATERIA_PRIMA) REFERENCES MATERIA_PRIMA(COD),
	CONSTRAINT COD_PRODUTO_FK KEY(COD_PRODUTO) REFERENCES PRODUTO(COD),
	PRIMARY KEY(COD));
