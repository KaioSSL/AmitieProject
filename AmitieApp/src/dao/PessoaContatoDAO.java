...
import objetos.PessoaContato;

/**
 *
 * @author kaiof
 */
public class PessoaContatoDAO extends PessoaContato {
    public static boolean insert(PessoaContato pesc) {
    ...
    public static boolean delete(PessoaContato pesc) {
        // Crio Conexão com o Servidor do Banco
        Connection con = ConnectionFactory.getConnection();
        // Crio meu Statement para tratar a query á ser utilizada
        PreparedStatement stmt = null;
    ...
    public static boolean update(PessoaContato pesc) {
        // Crio Conexão com o Servidor do Banco
        Connection con = ConnectionFactory.getConnection();
        // Crio meu Statement para tratar a query á ser utilizada
        PreparedStatement stmt = null;
