...
import objetos.TipoContato;

/**
 *
 * @author kaiof
 */
public class TipoContatoDAO extends TipoContato {
    public static boolean insert(TipoContato tc) {
    ...
    public static boolean delete(TipoContato tc) {
        // Crio Conexão com o Servidor do Banco
        Connection con = ConnectionFactory.getConnection();
        // Crio meu Statement para tratar a query á ser utilizada
        PreparedStatement stmt = null;
    ...
    public static boolean update(TipoContato tc) {
        // Crio Conexão com o Servidor do Banco
        Connection con = ConnectionFactory.getConnection();
        // Crio meu Statement para tratar a query á ser utilizada
        PreparedStatement stmt = null;
